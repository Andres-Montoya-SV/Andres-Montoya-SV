...
- Architecting APIs with less than 200ms response times
- Hardening services against vulnerabilities and misconfigurations
- Reducing operational load with automation and smart tooling
- Migrating legacy systems to scalable, cloud-native architectures
- Leading backend initiatives and mentoring engineering teams

### 🧠 Specialties
- High-load Node.js and Python backend services
- Secure payment processing and financial workflows
- Distributed systems & scalability design
- AI/ML system integration
- Observability, monitoring, and systems reliability
- API architecture, security, and performance tuning
